...
namespace TerrificNet.Thtml.Test
{
	public class EmitterTest
	{
		...
		public void TestEmit(string description, Document input, IDataBinder dataBinder, object data, VTree expected, CompilerExtensions compilerExtensions)
		{
			...
			method.Execute(data, new RenderingContext(new VDomOutputBuilder(builder)));
		...
		public static IEnumerable<object[]> TestData
		{
			get
			{
				...
				helperResult
					.Setup(d => d.Visit(It.IsAny<HelperParameters>()))
				...
				resultMock.Setup(r => r.Visit(It.IsAny<HelperParameters>())).Callback((HelperParameters p) =>
				{
